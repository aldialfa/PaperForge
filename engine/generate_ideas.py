...
def search_for_papers(query, result_limit=10, engine="semanticscholar") -> Union[None, List[Dict]]:
    ...
    if engine == "semanticscholar":
        debug_http = _is_truthy_env("PAPERFORGE_DEBUG_HTTP", "0")
        rsp = requests.get(
...
novelty_system_msg = """You are a rigorous PhD researcher who is looking to publish a paper that will contribute significantly to the field.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Generate PaperForge ideas")
